...
export default function Stats(){
    return(
        ...
        className="bg-white justify-center mx-auto flex flex-row border-b border-primary z-78 py-3 md:py-7 leading-1 overflow-hidden shadow-lg px-1 md:px-6 rounded-lg w-fit">
